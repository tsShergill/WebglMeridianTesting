            ...
            if (PosSectorNumber > -1) { // Is Sector Num a real Sector Num
                ...
                if (Side_Deff[SDPos].NormalBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDPos].WallFlags, 8) == 1) {
                        MakeWallNew(v1, v2, v3, v4, Side_Deff[SDPos].NormalBitmapNo, 1, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                    else {
                        MakeWallNew(v1, v2, v3, v4, Side_Deff[SDPos].NormalBitmapNo, 0, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                }
                if (Side_Deff[SDPos].BelowBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDPos].WallFlags, 7) == 1) {
                        MakeWallNew(v5, v1, v4, v6, Side_Deff[SDPos].BelowBitmapNo, 1, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                    else {
                        MakeWallNew(v5, v1, v4, v6, Side_Deff[SDPos].BelowBitmapNo, 0, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                }
                if (Side_Deff[SDPos].AboveBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDPos].WallFlags, 6) == 1) {
                        MakeWallNew(v2, v7, v8, v3, Side_Deff[SDPos].AboveBitmapNo, 0, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                    else {
                        MakeWallNew(v2, v7, v8, v3, Side_Deff[SDPos].AboveBitmapNo, 1, Side_Deff[SDPos].WallFlags, Roomedit_Wall[count].TextureXOffsetPos, Roomedit_Wall[count].TextureYOffsetPos);
                    }
                }
            }
        }
            ...
            if (NegSectorNumber > -1) { // Is Sector Num a real Sector Num
                ...
                if (Side_Deff[SDNeg].NormalBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDNeg].WallFlags, 8) == 1) {
                        MakeWallNew(v4, v3, v2, v1, Side_Deff[SDNeg].NormalBitmapNo, 1, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                    else {
                        MakeWallNew(v4, v3, v2, v1, Side_Deff[SDNeg].NormalBitmapNo, 0, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                }
                if (Side_Deff[SDNeg].BelowBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDNeg].WallFlags, 7) == 1) {
                        MakeWallNew(v6, v4, v1, v5, Side_Deff[SDNeg].BelowBitmapNo, 1, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                    else {
                        MakeWallNew(v6, v4, v1, v5, Side_Deff[SDNeg].BelowBitmapNo, 0, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                }
                if (Side_Deff[SDNeg].AboveBitmapNo > 0) { // Is there a texture, if not, dont render wall
                    if (CheckBit(Side_Deff[SDNeg].WallFlags, 6) == 1) {
                        MakeWallNew(v3, v8, v7, v2, Side_Deff[SDNeg].AboveBitmapNo, 0, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                    else {
                        MakeWallNew(v3, v8, v7, v2, Side_Deff[SDNeg].AboveBitmapNo, 1, Side_Deff[SDNeg].WallFlags, Roomedit_Wall[count].TextureXOffsetNeg, Roomedit_Wall[count].TextureYOffsetNeg);
                    }
                }
            }
        }
...
function MakeWallNew(v1, v2, v3, v4, TextureID, drawTopDown, WallFlags, Xoffset, Yoffset) {
    ...
    var bottom = Math.min(v1.z, v4.z);
    var top = Math.max(v2.z, v3.z);

    var uvhdif1 = (1 - (parseFloat(Yoffset) * BgfTextures[TextureID].shrinkfactor * invHeight)) - ((v1.z - v2.z) * BgfTextures[TextureID].shrinkfactor * invHeight);
    var uvhdif2 = (1 - (parseFloat(Yoffset) * BgfTextures[TextureID].shrinkfactor * invHeight));
    var uvhdif3 = (1 - (parseFloat(Yoffset) * BgfTextures[TextureID].shrinkfactor * invHeight));
    var uvhdif4 = (1 - (parseFloat(Yoffset) * BgfTextures[TextureID].shrinkfactor * invHeight)) - ((v4.z - v3.z) * BgfTextures[TextureID].shrinkfactor * invHeight);



    if (CheckBit(WallFlags, 0) == 1) {
        var uv1 = new THREE.Vector2(u1, uvhdif1);
        var uv2 = new THREE.Vector2(u1, uvhdif2);
        var uv3 = new THREE.Vector2(u2, uvhdif3);
        var uv4 = new THREE.Vector2(u2, uvhdif4);
    }
    else {
        var uv4 = new THREE.Vector2(u1, uvhdif1);
        var uv3 = new THREE.Vector2(u1, uvhdif2);
        var uv2 = new THREE.Vector2(u2, uvhdif3);
        var uv1 = new THREE.Vector2(u2, uvhdif4);
    }

    geom.faceVertexUvs[0].push([uv1, uv2, uv3]);
    geom.faceVertexUvs[0].push([uv1, uv3, uv4]);

    var file = "00000" + TextureID;
